...
## Project Structure
    ...
    ├── testadminsite_dev_41970  # Django project configurations
...
1. Clone this repo and `cd testadminsite_dev_41970`
...
2. Clone this repo and `cd testadminsite_dev_41970`
